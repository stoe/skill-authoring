...
`@stoe/skill-authoring` provides a small, dependency-free command-line tool for creating and validating [Agent Skills](https://docs.github.com/en/copilot) (`SKILL.md`-based packages) for GitHub Copilot. It is the implementation behind the `skill-authoring` skill in [stoe/skills](https://github.com/stoe/skills), extracted here so it can be installed and versioned independently.
...
# or as a devDependency in a skills workspace
...
## Relationship to stoe/skills

This package is the CLI implementation behind the `skill-authoring` Copilot skill defined in [stoe/skills](https://github.com/stoe/skills) (`skills/skill-authoring/SKILL.md`). That repository documents the authoring conventions and workflow; this package provides the tooling that enforces them.
